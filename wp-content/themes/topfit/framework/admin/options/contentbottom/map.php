...
if (!function_exists('topfit_mikado_content_bottom_options_map')) {

	function topfit_mikado_content_bottom_options_map() {
		...
		$panel_content_bottom = topfit_mikado_add_admin_panel(
			array(
				'page'  => '_content_bottom_page',
				'name'  => 'panel_content_bottom',
				'title' => esc_html__('Content Bottom Area', 'topfit'),
			)
		);
		...
		$enable_content_bottom_area_container = topfit_mikado_add_admin_container(
			array(
				'parent'          => $panel_content_bottom,
		...
		topfit_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__('Widget Area to Display', 'topfit'),
			'description'   => esc_html__('Choose a Content Bottom widget area to display', 'topfit'),
	...
	add_action('topfit_mikado_options_map', 'topfit_mikado_content_bottom_options_map', 16);

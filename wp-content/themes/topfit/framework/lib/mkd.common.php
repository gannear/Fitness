...
$topfit_options_fontstyle     = array(
	"normal" => "normal",
	"italic" => "italic"
);
$topfit_options_fontweight    = array(
	"100" => "100",
	"200" => "200",
	"300" => "300",
	"400" => "400",
...
$topfit_options_texttransform = array(
	"none"       => "None",
...
$topfit_options_fontdecoration = array(
	"none"      => "none",
	"underline" => "underline"
);

$topfit_options_arrows_type = array(
...
$topfit_options_double_arrows_type = array(
	'fa fa-angle-double-'          => 'fa-angle-double',
	'arrow_carrot-2'               => 'arrow_carrot-2',
	'arrow_carrot-2left_alt2'      => 'arrow_carrot 2 alt2',
	'icon-arrows-left-double-32'   => 'icon-arrows double',
...
$topfit_options_arrows_up_type = array(

...
class HeaderMinimal extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
			...
			$menuAreaHeight       = topfit_mikado_filter_px(topfit_mikado_options()->getOptionValue('menu_area_height_header_minimal'));
	...
	public function headerPerPageStyles($style) {
        ...
        $disable_shadow = topfit_mikado_get_meta_field_intersect('menu_area_shadow_header_minimal',$id) == 'no';
        $disable_grid_shadow = topfit_mikado_get_meta_field_intersect('menu_area_in_grid_shadow_header_minimal',$id) == 'no';
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters['menu_area_in_grid'] = topfit_mikado_get_meta_field_intersect('menu_area_in_grid_header_minimal',$id) == 'yes' ? true : false;

		$parameters = apply_filters('topfit_mikado_header_minimal_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		} elseif(topfit_mikado_options()->getOptionValue('menu_area_background_color_header_minimal') == '') {
			$menuAreaTransparent = topfit_mikado_options()->getOptionValue('menu_area_grid_background_color_header_minimal') !== '' &&
			                       topfit_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_minimal') !== '1';
		} else {
			$menuAreaTransparent = topfit_mikado_options()->getOptionValue('menu_area_background_color_header_minimal') !== '' &&
			                       topfit_mikado_options()->getOptionValue('menu_area_background_transparency_header_minimal') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_minimal_meta', true) !== '') {
			...
			$menuAreaTransparent = topfit_mikado_options()->getOptionValue('menu_area_grid_background_color_header_minimal') !== '' &&
			                       topfit_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_minimal') === '0';
		} else {
			$menuAreaTransparent = topfit_mikado_options()->getOptionValue('menu_area_background_color_header_minimal') !== '' &&
			                       topfit_mikado_options()->getOptionValue('menu_area_background_transparency_header_minimal') === '0';
		}

<div class="mkd-fullscreen-menu-holder-outer">
    <div class="mkd-fullscreen-menu-holder" <?php topfit_mikado_inline_style(array($fullscreen_background_image)); ?>>
        <div class="mkd-fullscreen-menu-holder-inner">
            ...
            <div class="mkd-container-inner">
                ...
                if($have_logo){
                    topfit_mikado_get_fullscreeen_logo();
                }
                ...
                //Navigation
                topfit_mikado_get_full_screen_menu_navigation();

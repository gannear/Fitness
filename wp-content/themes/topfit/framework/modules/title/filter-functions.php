...
if (!function_exists('topfit_mikado_title_classes')) {
	/**
	 ...
	 */
	function topfit_mikado_title_classes($classes = array()) {
		$classes = array();
		$classes = apply_filters('topfit_mikado_title_classes', $classes);
...
if (!function_exists('topfit_mikado_title_type_class')) {
	/**
	 ...
	 */
	function topfit_mikado_title_type_class($classes) {
		$id = topfit_mikado_get_page_id();

		if (($meta_temp = get_post_meta($id, "mkd_title_area_type_meta", true)) !== "") {
			$title_type = $meta_temp;
		} else {
			$title_type = topfit_mikado_options()->getOptionValue('title_area_type');
		}
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_type_class');
}

if (!function_exists('topfit_mikado_title_background_image_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function topfit_mikado_title_background_image_classes($classes) {
		//init variables
		$id = topfit_mikado_get_page_id();
		$is_img_responsive = '';
		$is_image_parallax = '';
		...
		if (($meta_temp = get_post_meta($id, "mkd_title_area_background_image_meta", true)) != "") {
			...
			$title_img = topfit_mikado_options()->getOptionValue('title_area_background_image');
		}
		...
		if (($meta_temp = get_post_meta($id, "mkd_title_area_background_image_parallax_meta", true)) != "") {
			...
			$is_image_parallax = topfit_mikado_options()->getOptionValue('title_area_background_image_parallax');
		}
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_background_image_classes');
}

if (!function_exists('topfit_mikado_title_content_alignment_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function topfit_mikado_title_content_alignment_class($classes) {
		...
		if (($meta_temp = get_post_meta($id, "mkd_title_area_content_alignment_meta", true)) != "") {
			...
			$title_content_alignment = topfit_mikado_options()->getOptionValue('title_area_content_alignment');
		}
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_content_alignment_class');
}

if (!function_exists('topfit_mikado_title_in_grid_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function topfit_mikado_title_in_grid_class($classes) {

		//init variables
		$id = topfit_mikado_get_page_id();
		$title_in_grid = topfit_mikado_get_meta_field_intersect('title_in_grid', $id);
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_in_grid_class');
}

if (!function_exists('topfit_mikado_title_animation_class')) {
	/**
	 * Function that adds class on title based on title animation option
	 *
	 * @param $classes original array of classes
	 ...
	 * @return array changed array of classes
	 */
	function topfit_mikado_title_animation_class($classes) {
		...
		if (($meta_temp = get_post_meta($id, "mkd_title_area_animation_meta", true)) !== "") {
			...
			$title_animation = topfit_mikado_options()->getOptionValue('title_area_animation');
		}
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_animation_class');
}

if (!function_exists('topfit_mikado_title_background_image_div_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function topfit_mikado_title_background_image_div_classes($classes) {
	...
	add_filter('topfit_mikado_title_classes', 'topfit_mikado_title_background_image_div_classes');
}

if (!function_exists('topfit_mikado_has_subtitle_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function topfit_mikado_has_subtitle_body_class($classes) {
		$id = topfit_mikado_get_page_id();
	...
	add_action('body_class', 'topfit_mikado_has_subtitle_body_class');
}
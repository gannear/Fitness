<?php if (topfit_mikado_options()->getOptionValue('portfolio_single_hide_pagination') !== 'yes') : ?>

	<?php
	$back_to_link = get_post_meta(get_the_ID(), 'portfolio_single_back_to_link', true);
	$nav_same_category = topfit_mikado_options()->getOptionValue('portfolio_single_nav_same_category') == 'yes';
	?>
					...
					<?php if ($prev_post_has_image) : ?>
						<div class="mkd-single-nav-image-holder">
							<a href="<?php echo esc_url($prev_post['link']); ?>">
								<?php echo topfit_mikado_kses_img($prev_post['image']); ?>
							</a>
						</div>
					<?php endif; ?>
			...
			<?php if ($back_to_link !== '') : ?>
				<div class="mkd-portfolio-back-btn">
					<a href="<?php echo esc_url(get_permalink($back_to_link)); ?>">
						<?php esc_html_e('MAIN LIST','topfit'); ?>
					</a>
				</div>
			<?php endif; ?>
			...
			<?php if ($has_next_post) : ?>
				<div class="mkd-portfolio-next <?php if ($next_post_has_image) {
					...
					<?php if ($next_post_has_image) : ?>
						<div class="mkd-single-nav-image-holder">
							<a href="<?php echo esc_url($next_post['link']); ?>">
								<?php echo topfit_mikado_kses_img($next_post['image']); ?>
							</a>
						</div>
					<?php endif; ?>
				</div>

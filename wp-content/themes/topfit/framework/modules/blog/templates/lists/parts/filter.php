<?php
$filter = esc_attr(topfit_mikado_options()->getOptionValue('masonry_filter'));

if($filter == 'yes') {
    $page_category = get_post_meta(topfit_mikado_get_page_id(), "mkd_blog_category_meta", true);
    if(is_category()) {
            ...
            <div class="mkd-filter-blog">
                <ul>
                    <li class="mkd-filter mkd-active" data-filter="*">
                        <span><?php esc_html_e('All', 'topfit'); ?></span></li>

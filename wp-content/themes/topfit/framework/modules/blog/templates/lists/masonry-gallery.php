<?php topfit_mikado_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
...
if (topfit_mikado_options()->getOptionValue('pagination') == 'yes') :
	topfit_mikado_pagination($blog_query->max_num_pages, $blog_page_range, $paged, $blog_type);
endif;

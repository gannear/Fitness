<?php if (topfit_mikado_options()->getOptionValue('blog_single_navigation') == 'yes') { ?>
	<?php $navigation_blog_through_category = topfit_mikado_options()->getOptionValue('blog_navigation_through_same_category') ?>

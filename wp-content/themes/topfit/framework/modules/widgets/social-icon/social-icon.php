 ...
 */
class TopFitMikadoSocialIconWidget extends TopFitMikadoWidget {
	/**
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__('Mikado Social Icon Widget', 'topfit') // Name
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			topfit_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Link', 'topfit'),
					'name'        => 'link',
					'description' => ''
				),
				array(
					'type'        => 'dropdown',
					'title'       => esc_html__('Target', 'topfit'),
					'name'        => 'target',
					'options'     => array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Text Size (px)', 'topfit'),
					'name'        => 'text_size',
					'description' => ''
				),
				array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Hover Color', 'topfit'),
					'name'        => 'hover_color',
					'description' => ''
				),
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Margin', 'topfit'),
					'name'        => 'margin',
	...
	public function widget($args, $instance) {
		...
		<a class="mkd-social-icon-widget-holder" <?php echo topfit_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php topfit_mikado_inline_style($social_icon_styles) ?>

<?php
if (!function_exists('topfit_mikado_accordions_map')) {
	/**
	 * Add Accordion options to elements panel
	 */
	function topfit_mikado_accordions_map() {

		$panel = topfit_mikado_add_admin_panel(array(
			'title' => esc_html__('Accordions', 'topfit'),
		...
		$typography_group = topfit_mikado_add_admin_group(array(
			...
			'title'       => esc_html__('Typography', 'topfit'),
			'description' => esc_html__('Setup typography for accordions navigation', 'topfit'),
			'parent'      => $panel
		));
		...
		topfit_mikado_add_admin_section_title(array(
			...
			'title'  => esc_html__('Basic Accordions Color Styles', 'topfit'),
			'parent' => $panel
		));

		$accordions_color_group = topfit_mikado_add_admin_group(array(
			'name'        => 'accordions_color_group',
			'title'       => esc_html__('Accordion Color Styles', 'topfit'),
			'description' => esc_html__('Set color styles for accordion title', 'topfit'),
			'parent'      => $panel
		));
		$accordions_color_row = topfit_mikado_add_admin_row(array(
		...
		topfit_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__('Icon Background Color', 'topfit')
		));

		$active_accordions_color_group = topfit_mikado_add_admin_group(array(
			'name'        => 'active_accordions_color_group',
			'title'       => esc_html__('Active and Hover Accordion Color Styles', 'topfit'),
			'description' => esc_html__('Set color styles for active and hover accordions', 'topfit'),
			'parent'      => $panel
		));
		$active_accordions_color_row = topfit_mikado_add_admin_row(array(
		...
		topfit_mikado_add_admin_section_title(array(
			...
			'title'  => esc_html__('Boxed Accordion Title Color Styles', 'topfit'),
			'parent' => $panel
		));
		$boxed_accordions_color_group = topfit_mikado_add_admin_group(array(
			'name'        => 'boxed_accordions_color_group',
			'title'       => esc_html__('Boxed Accordion Title Color Styles', 'topfit'),
			'description' => esc_html__('Set color styles for boxed accordion title', 'topfit'),
			'parent'      => $panel
		));
		$boxed_accordions_color_row = topfit_mikado_add_admin_row(array(
		...
		$active_boxed_accordions_color_group = topfit_mikado_add_admin_group(array(
			'name'        => 'active_boxed_accordions_color_group',
			'title'       => esc_html__('Active and Hover Title Color Styles', 'topfit'),
			'description' => esc_html__('Set color styles for active and hover accordions', 'topfit'),
			'parent'      => $panel
		));
		$active_boxed_accordions_color_row = topfit_mikado_add_admin_row(array(
	...
	add_action('topfit_mikado_options_elements_map', 'topfit_mikado_accordions_map', 11);
}
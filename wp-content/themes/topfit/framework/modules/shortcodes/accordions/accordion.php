<?php
namespace TopFit\Modules\Accordion;
...
class Accordion implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                    => esc_html__('Accordion', 'topfit'),
			'base'                    => $this->base,
			...
			'params'                  => array(
				...
				array(
					...
					'param_name'  => 'style',
					'value'       => array(
						esc_html__('Accordion', 'topfit')       => 'accordion',
						esc_html__('Boxed Accordion', 'topfit') => 'boxed_accordion',
						esc_html__('Toggle', 'topfit')          => 'toggle',
						esc_html__('Boxed Toggle', 'topfit')    => 'boxed_toggle'
					),
					'save_always' => true,
					'description' => ''
				)
	...
	public function render($atts, $content = null) {
		...
		$output .= topfit_mikado_get_shortcode_module_template_part('templates/accordion-holder-template', 'accordions', '', $params);

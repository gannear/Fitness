...
namespace TopFit\Modules\Shortcodes\CardsGallery;
...
class CardsGallery implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Cards Gallery','topfit'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
			...
			'params'                    => array(
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Cards Background Color','topfit'),
                    'param_name'  => 'background_color'
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Rounded Edges', 'topfit'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Layout', 'topfit'),
                    'param_name'  => 'layout',
                    'value'       => array(
                        esc_html__('Standard', 'topfit')  => 'standard',
                        esc_html__('Shuffled left', 'topfit') => 'shuffled-left',
                        esc_html__('Shuffled right', 'topfit') => 'shuffled-right',
                    ),
                    'save_always' => true,
                    'admin_label' => true
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Bundle Animation', 'topfit'),
	...
	public function render($atts, $content = null) {
		...
		return topfit_mikado_get_shortcode_module_template_part('templates/cards-gallery', 'cards-gallery', '', $params);
	}
    ...
    private function getGalleryImages($params) {
        ...
        foreach($image_ids as $id) {
            ...
            $image_dimensions = topfit_mikado_get_image_dimensions($image['url']);

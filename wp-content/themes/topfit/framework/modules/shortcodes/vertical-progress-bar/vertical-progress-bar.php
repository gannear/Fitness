...
namespace TopFit\Modules\Shortcodes\VerticalProgressBar;
...
class VerticalProgressBar implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Vertical Progress Bar', 'topfit'),
			'base'                      => $this->base,
	...
	public function render($atts, $content = null) {
		...
		return topfit_mikado_get_shortcode_module_template_part('templates/vertical-progress-bar', 'vertical-progress-bar', '', $params);
	}

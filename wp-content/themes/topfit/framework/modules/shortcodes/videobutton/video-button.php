<?php
namespace TopFit\Modules\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Video Button', 'topfit'),
			'base'                      => $this->getBase(),
			'category'                  => 'by MIKADO',
			...
			'params'                    => array(
				array(
					'type'       => 'textfield',
					'heading'    => esc_html__('Video Link', 'topfit'),
					'param_name' => 'video_link',
					'value'      => ''
				),
				array(
					'type'       => 'textfield',
					'heading'    => esc_html__('Play Button Size (px)', 'topfit'),
				...
				array(
					'type'        => 'dropdown',
					'admin_label' => true,
					'heading'     => esc_html__('Video Button Style', 'topfit'),
	...
	public function render($atts, $content = null) {
		...
		$html = topfit_mikado_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);

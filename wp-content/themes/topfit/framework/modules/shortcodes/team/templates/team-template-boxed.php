...
<div class="mkd-team <?php echo esc_attr($team_type) ?>">
	<div class="mkd-team-inner clearfix">
		<?php if (!empty($phone_number)) : ?>
			<div class="mkd-phone-number-holder">
				<a class="mkd-phone-number-holder-inner" href="tel:<?php echo esc_attr($phone_number); ?>">
					<span
						class="mkd-phone-icon"><?php echo topfit_mikado_icon_collections()->renderIcon('icon_phone', 'font_elegant'); ?></span>
					<span class="mkd-phone-number"><?php echo esc_attr($phone_number); ?></span>
				</a>
			</div>
		<?php endif; ?>
		<?php if ($team_image !== '') { ?>
			...
			<div class="mkd-team-info">
				<?php if ($team_name !== '' || $team_position !== '') { ?>
					<div class="mkd-team-title-holder">
						<?php if ($team_name !== '') { ?>
							<h4 class="mkd-team-name"><?php echo esc_attr($team_name); ?></h4>
						<?php } ?>

<div <?php topfit_mikado_class_attribute($pricing_table_classes) ?>>
	<div class="mkd-price-table-inner">
		...
		<ul>
			<li class="mkd-table-prices">
				<div class="mkd-price-in-table" <?php topfit_mikado_inline_style($price_styles); ?>>
					<?php if (!empty($price)) : ?>
			...
			<li class="mkd-table-title">
				<h3 <?php topfit_mikado_inline_style($title_styles); ?>
					class="mkd-title-content"><?php echo esc_html($title) ?></h3>
			</li>

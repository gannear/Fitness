...
class Tab implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$default_atts = array(
			'tab_title'        => esc_html__('Tab', 'topfit'),
			'tab_id'           => '',
			'background_image' => ''
		);
		...
		$output = '';
		$output .= topfit_mikado_get_shortcode_module_template_part('templates/tab_content', 'tabs', '', $params);

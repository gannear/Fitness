...
class Tabs implements ShortcodeInterface {
		...
		vc_map(array(
			...
			'params'                  => array(
				array(
					...
					'param_name'  => 'style',
					'value'       => array(
						esc_html__('Horizontal With Text', 'topfit')           => 'horizontal_with_text',
						esc_html__('Horizontal With Icons', 'topfit')          => 'horizontal_with_icons',
						esc_html__('Horizontal With Text And Icons', 'topfit') => 'horizontal_with_text_and_icons',
						esc_html__('Vertical With Text', 'topfit')             => 'vertical_with_text',
						esc_html__('Vertical With Icons', 'topfit')            => 'vertical_with_icons',
						esc_html__('Vertical With Text and Icons', 'topfit')   => 'vertical_with_text_and_icons'
					),
					'save_always' => true,
					'description' => ''
				),
				array(
					'heading'     => esc_html__('Navigation Width', 'topfit'),
					'type'        => 'dropdown',
					'admin-label' => true,
					'param_name'  => 'navigation_width',
					'value'       => array(
						esc_html__('Medium', 'topfit') => '',
	...
	public function render($atts, $content = null) {
		...
		$output .= topfit_mikado_get_shortcode_module_template_part('templates/' . $tabs_type, 'tabs', '', $params);

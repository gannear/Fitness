		...
		<ul class="mkd-timeline-navigation">
			<li>
				<a href="#0" class="prev inactive">
					<?php echo topfit_mikado_icon_collections()->renderIcon('arrow_carrot-left_alt2', 'font_elegant'); ?>
				</a>
			</li>
			<li>
				<a href="#0" class="next">
					<?php echo topfit_mikado_icon_collections()->renderIcon('arrow_carrot-right_alt2', 'font_elegant'); ?>
				</a>
			</li>
		</ul> <!-- .mkd-timeline-navigation -->
	</div> <!-- .timeline -->
	<?php else: ?>
		<p><?php esc_html_e('Please add some events to timeline', 'topfit'); ?></p>
	<?php endif; ?>
</div>
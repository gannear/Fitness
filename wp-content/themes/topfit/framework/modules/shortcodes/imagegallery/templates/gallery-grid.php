				...
				<div class="mkd-image-gallery-holder">
					...
					<a href="<?php echo esc_url($image['url']) ?>" data-rel="prettyPhoto[single_pretty_photo]"
					   title="<?php echo esc_attr($image['title']); ?>">
						...
						?>
						<div
							class="mkd-icon-holder"><?php echo topfit_mikado_icon_collections()->renderIcon('icon_plus', 'font_elegant'); ?></div>
						<?php } ?>
						<?php if (is_array($image_size) && count($image_size)) : ?>
							<?php echo topfit_mikado_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]); ?>
						<?php else: ?>

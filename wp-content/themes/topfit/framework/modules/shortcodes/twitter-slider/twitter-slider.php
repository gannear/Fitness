<?php
namespace TopFit\Modules\Shortcodes\TwitterSlider;
...
class TwitterSlider implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Twitter Slider', 'topfit'),
			'base'                      => $this->base,
			...
			'params'                    => array(
				array(
					'type'        => 'textfield',
					'heading'     => esc_html__('User ID', 'topfit'),
					'param_name'  => 'user_id',
					'value'       => '',
					'admin_label' => true
				),
				array(
					'type'        => 'textfield',
					'heading'     => esc_html__('Number of tweets', 'topfit'),
					'param_name'  => 'count',
					'value'       => '',
					'description' => esc_html__('Default Number is 4', 'topfit'),
					'admin_label' => true
				),
				array(
					'type'        => 'colorpicker',
					'heading'     => esc_html__('Tweets Color', 'topfit'),
				...
				array(
					'type'        => 'textfield',
					'class'       => '',
					'heading'     => esc_html__('Tweet Cache Time', 'topfit'),
	...
	public function render($atts, $content = null) {
		...
		if ($twitter_api->hasUserConnected()) {
			...
			$html .= topfit_mikado_get_shortcode_module_template_part('templates/twitter-slider', 'twitter-slider', '', $params);
		} else {
			$html .= esc_html__('It seams that you haven\'t connected with your Twitter account', 'topfit');
		}

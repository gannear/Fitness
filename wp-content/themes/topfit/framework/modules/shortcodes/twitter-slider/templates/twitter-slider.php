<?php if ($response->status) : ?>
	<?php if (is_array($response->data) && count($response->data)) : ?>
		<div class="mkd-twitter-slider clearfix">
			<span aria-hidden="true" class="twitter-icon mkd-icon-font-elegant social_twitter" <?php topfit_mikado_inline_style($tweet_styles); ?>></span>
			<div class="mkd-twitter-slider-inner" <?php topfit_mikado_inline_style($tweet_styles); ?>>

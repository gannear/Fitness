<?php
namespace TopFit\Modules\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Pie Chart', 'topfit'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array(
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Type of Central text', 'topfit'),
					'param_name'  => 'type_of_central_text',
					'value'       => array(
						esc_html__('Percent', 'topfit') => 'percent',
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Typography Style', 'topfit'),
	...
	public function render($atts, $content = null) {
		...
		$html = topfit_mikado_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);

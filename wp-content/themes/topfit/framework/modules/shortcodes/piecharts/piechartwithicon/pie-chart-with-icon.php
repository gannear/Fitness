<?php
namespace TopFit\Modules\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Pie Chart With Icon', 'topfit'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array_merge(
				array(
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Percentage', 'topfit'),
						'param_name'  => 'percent',
						'description' => '',
						'admin_label' => true
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Size(px)', 'topfit'),
						'param_name'  => 'size',
						'description' => '',
						'admin_label' => true,
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Active Color', 'topfit'),
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Inactive Color', 'topfit'),
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Margin below chart (px)', 'topfit'),
				...
				topfit_mikado_icon_collections()->getVCParamsArray(),
				array(
					array(
						'type'       => 'colorpicker',
	...
	public function render($atts, $content = null) {
		...
		$params['active_color'] = $params['active_color'] !== '' ? $params['active_color'] : topfit_mikado_get_first_main_color();
		...
		$html = topfit_mikado_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = topfit_mikado_icon_collections()->renderIcon($params[$icon], $params['icon_pack'], $iconStyles);

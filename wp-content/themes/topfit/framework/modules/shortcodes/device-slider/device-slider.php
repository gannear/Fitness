...
namespace TopFit\Modules\Shortcodes\DeviceSlider;
...
class DeviceSlider implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Device Slider', 'topfit'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		return topfit_mikado_get_shortcode_module_template_part('templates/device-slider-template', 'device-slider', '', $params);
	}

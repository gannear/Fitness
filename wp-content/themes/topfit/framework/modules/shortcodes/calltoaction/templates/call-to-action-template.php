...
<?php } ?>
	...
	<div class="mkd-call-to-action <?php echo esc_attr($type) ?>">
		...
		if ($grid_size == "75") { ?>
			<div class="mkd-call-to-action-row-75-25 clearfix"  <?php topfit_mikado_inline_style($call_to_action_styles); ?>>
		<?php } elseif ($grid_size == "66") { ?>
			<div class="mkd-call-to-action-row-66-33 clearfix"  <?php topfit_mikado_inline_style($call_to_action_styles); ?>>
		<?php } else { ?>
			<div class="mkd-call-to-action-row-50-50 clearfix"  <?php topfit_mikado_inline_style($call_to_action_styles); ?>>
		<?php } ?>
				...
				<?php } ?>
					...
					<div class="mkd-call-to-action-text" <?php echo topfit_mikado_get_inline_style($content_styles) ?>>
						<?php
						echo topfit_mikado_remove_auto_ptag($content, true);
						?>
					</div>

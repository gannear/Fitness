<?php
namespace TopFit\Modules\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Blockquote', 'topfit'),
			'base'                      => $this->getBase(),
			'category'                  => 'by MIKADO',
			...
			'params'                    => array(
				array(
					...
					'param_name'  => 'text',
					'value'       => esc_html__('Blockquote text', 'topfit'),
					'save_always' => true
				),
				array(
					'type'       => 'textfield',
	...
	public function render($atts, $content = null) {
		...
		$html = topfit_mikado_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);

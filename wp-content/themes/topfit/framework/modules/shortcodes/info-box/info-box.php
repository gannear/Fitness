<?php
namespace TopFit\Modules\Shortcodes\InfoBox;
...
class InfoBox implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Info Box', 'topfit'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
			'icon'                      => 'icon-wpb-info-box extended-custom-icon',
			'allowed_container_element' => 'vc_row',
			'params'                    => array_merge(
				topfit_mikado_icon_collections()->getVCParamsArray('', '', true),
				array(
					array(
						'type'        => 'textfield',
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Background Color', 'topfit'),
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Text Color', 'topfit'),
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Border Color', 'topfit'),
	...
	public function render($atts, $content = null) {
		...
		$defaultAtts = array_merge($defaultAtts, topfit_mikado_icon_collections()->getShortcodeParams());
		...
		return topfit_mikado_get_shortcode_module_template_part('templates/info-box-template', 'info-box', '', $params);
	}

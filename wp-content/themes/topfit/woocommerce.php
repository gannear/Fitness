...
if(topfit_mikado_options()->getOptionValue('mkd_woo_products_list_full_width') == 'yes' && !is_singular('product')) {
	$mkd_full_width = true;
}

if($mkd_full_width) { ?>
<div class="mkd-full-width" <?php topfit_mikado_inline_style($mkd_background_color); ?>>
	<?php } else { ?>
	<div class="mkd-container" <?php topfit_mikado_inline_style($mkd_background_color); ?>>
		<?php }
		if($mkd_full_width) { ?>
		<div class="mkd-full-width-inner" <?php topfit_mikado_inline_style($mkd_content_style); ?>>
			<?php } else { ?>
			<div class="mkd-container-inner clearfix" <?php topfit_mikado_inline_style($mkd_content_style); ?>>
				<?php }
				...
				if(!is_singular('product')) {
					...
					switch($mkd_sidebar) {
							...
							<div class="mkd-two-columns-66-33 grid2 mkd-woocommerce-with-sidebar clearfix">
								<div class="mkd-column1">
									<div class="mkd-column-inner">
										<?php topfit_mikado_woocommerce_content(); ?>
									</div>
								</div>
						...
						case 'sidebar-25-left': ?>
							...
							break;
						default:
							topfit_mikado_woocommerce_content();
					}

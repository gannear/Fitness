<?php
if(!function_exists('topfit_mikado_get_gradient_left_to_right_styles')) {
    function topfit_mikado_get_gradient_left_to_right_styles($string_add = '', $empty_val = false, $custom_val = false) {
        $styles = array(
...
if(!function_exists('topfit_mikado_get_gradient_bottom_to_top_styles')) {
    function topfit_mikado_get_gradient_bottom_to_top_styles($string_add = '', $empty_val = false) {
        $styles = array(
...
if(!function_exists('topfit_mikado_get_gradient_left_bottom_to_right_top_styles')) {
    function topfit_mikado_get_gradient_left_bottom_to_right_top_styles($string_add = '', $empty_val = false) {
        $styles = array(

...
class AppPresser_Notifications {
	...
	*/
	...
	public function includes() {
		...
		require_once 'inc/AppPresser_API_Response_Viewer.php';
		...
		// Push log
		$this->classy( 'push_log', 'Log' );
		$this->classy( 'push_log_cpt', 'Log_CPT' );
	...
	public function ssl_curl_required() {
		$curl_version = curl_version();
		echo '<div id="message" class="error"><p>'. sprintf( __( '%1$s requires a CURL version that supports OpenSSL. Contact your hosting provider to update CURL on your server.  <br><b>Your versions:</b><br>CURL version: ' . $curl_version['version'] . '<br>SSL version: '.$curl_version['ssl_version'], 'apppresser-push' ), self::PLUGIN ) .'</p></div>';
	}

...
= 3.4.0 =
* Add option for pushing notification logging
* Add option to disable push notifications for development test
* Fix notification titles for scheduled posts

= 3.3.1 =
* Minor bug fix to catch an unset variable

= 3.3.0 =
* Extend CURL timeout when contacting myapppresser.com API

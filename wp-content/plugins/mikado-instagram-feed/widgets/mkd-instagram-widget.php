	...
	protected function setParams() {
		$this->params = array(
			...
			array(
				'name'  => 'tag',
				'type'  => 'textfield',
				'title' => esc_html__('Tag', 'mkd-instagram-feed')
			),
			array(
			...
			array(
				...
				'options' => array(
					...
					'8' => esc_html__('Eight', 'mkd-instagram-feed'),
					...
					<li>
						<div class="mkd-instagram-item-holder">
							<a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>"
							   target="_blank">
								<?php if (function_exists('topfit_mikado_kses_img')) : ?>
									<?php echo topfit_mikado_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
								<?php else : ?>
									...
									<div class="mkd-instagram-overlay">
										<div class="mkd-instagram-overlay-inner">
											<div class="mkd-instagram-overlay-inner2">
												<span class="overlay-icon social-instagram"><?php echo topfit_mikado_icon_collections()->renderIcon('social_instagram', 'font_elegant'); ?></span>
											</div>
										</div>
									</div>

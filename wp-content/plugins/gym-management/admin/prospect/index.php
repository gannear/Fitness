		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-white">
					<div class="panel-body">
	<h2 class="nav-tab-wrapper">
    	<a href="?page=gmgt_prospect&tab=memberlist" class="nav-tab <?php echo $active_tab == 'memberlist' ? 'nav-tab-active' : ''; ?>">
		...
		<a href="?page=gmgt_prospect&tab=viewmember&action=view&member_id=<?php echo $_REQUEST['member_id'];?>" class="nav-tab <?php echo $active_tab == 'viewmember' ? 'nav-tab-active' : ''; ?>">
...
$(document).ready(function() {
    ...
    <form name="member_form" action="" method="post">
        ...
        <tbody>
         <?php 
		$get_members = array('meta_key'=>'member_type','meta_value'=>'Prospect','role' => 'member');
		 ...
		 ?>
            ...
            <td class="action"> 
               	   <a href="?page=gmgt_prospect&tab=viewmember&action=view&member_id=<?php echo $retrieved_data->ID?>" class="btn btn-success"> <?php _e('View', 'gym_mgt' ) ;?></a>

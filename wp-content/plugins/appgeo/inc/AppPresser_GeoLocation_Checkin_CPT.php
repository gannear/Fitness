...
class AppGeo_CPT {
	...
	public function checkin_map( $post ) {
		...
		if ( $this->longitude && $this->latitude ) {
			echo '<img id="appp_map_preview_img" src="https://maps.googleapis.com/maps/api/staticmap?zoom=17&size=600x300&maptype=roadmap&markers=color:red%7Ccolor:red%7Clabel:%7C'. $this->latitude .','. $this->longitude . $api_key .'" style="max-width:100%">';
		}
	}

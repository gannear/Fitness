...
class AppPresser_GeoLocation_Settings {
	...
	public function geolocation_settings( $appp ) {
		...
		$appp->add_setting( 'googlemap_api_key', __( 'Google Map API Key', 'appgeo'), array( 'type' => 'text', 'tab' => 'appp-geo', 'description' => sprintf( __( 'Need a <a href="%s" target="_blank">Google Map API key</a>?', 'appgeo'), 'https://docs.apppresser.com/article/124-appgeolocation' ) ) );

		$appp->add_setting( 'appcheckin_anonymous', __('Anonymous checkins', 'appgeo'), array( 'type' => 'checkbox', 'tab' => 'appp-geo', 'description' => __('Login will not be required to checkin.') ) );

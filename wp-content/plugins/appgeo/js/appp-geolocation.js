...
(function(window, document, $, undefined) {
	...
	AppGeolocation.onSuccessGeoPost = function( position ) {
		...
		if ( position && $map.length ){
			...
			$map.attr( 'src', 'https://maps.googleapis.com/maps/api/staticmap?zoom=17&size=600x300&maptype=roadmap&markers=color:red%7Ccolor:red%7Clabel:%7C' + position.coords.latitude + ',' + position.coords.longitude + '&sensor=false' + key );
		}

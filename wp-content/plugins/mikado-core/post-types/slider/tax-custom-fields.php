...
function mkd_slides_category_taxonomy_custom_fields($tag) {
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Anchor', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Effect on header (dark/light style)', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<!--    <tr class="form-field">-->
	<!--        <th scope="row" valign="top">-->
	<!--            <label for="shortcode">--><?php //_e('Show prev/next thumbs (except for side menu or passepartout)', 'mkd-core'); ?><!--</label>-->
	<!--        </th>-->
	<!--        <td>-->
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Show slide number', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Parallax effect', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Time between slide transitions in milliseconds', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Slider height in px', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Responsive height', 'mkd-core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 1 (values: 0-1, default value: 1)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php _e('Title', 'mkd-core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php _e('Subtitle', 'mkd-core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php _e('Text', 'mkd-core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php _e('Button', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width > 1600px for 'set1' and 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 2 (values: 0-1, default value: 1)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width = [1200px,1600px] for 'set1', screen width = [1300px,1600px] for 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 3 (values: 0-1, default value: 0.8)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width = [900px,1200px] for 'set1', screen width = [1000px,1300px] for 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 4 (values: 0-1, default value: 0.7)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width = [650px,900px] for 'set1', screen width = [768px,1000px] for 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 5 (values: 0-1, default value: 0.6)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width = [500px,650px] for 'set1', screen width = [567px,768px] for 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 6 (values: 0-1, default value: 0.5)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width = [320px,500px] for 'set1', screen width = [320px,567px] for 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Breakpoint Coefficients 7 (values: 0-1, default value: 0.4)', 'mkd-core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php _e('Graphic', 'mkd-core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php _e("screen width < 320px for 'set1' and 'set2'", 'mkd-core'); ?></span>
		</td>
	</tr>
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php _e('Slider shortcode', 'mkd-core'); ?></label>
		</th>
		<td>
			...
			<span class="description"><?php _e('Use this shortcode to insert it on page', 'mkd-core'); ?></span>
		</td>
	</tr>

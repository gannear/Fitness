...
<?php
$video_type = topfit_mikado_get_portfolio_single_type() === 'video';
			...
			<div class="mkd-ptf-wrapper">
				<div class="mkd-ptf-item-image-holder">
					...
					<a <?php echo topfit_mikado_get_inline_attrs($link_atts); ?>>
						...
						<?php endif; ?>
						<?php if ($standard_boxed !== 'yes'): ?>
							<div class="mkd-portfolio-standard-overlay"
								 style="background-color: <?php esc_attr_e($background_color); ?>">

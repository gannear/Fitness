var wooobject = {
	...
	states : jQuery.parseJSON( woocommerce_params.countries.replace(/&quot;/g, '"') ),
	...
	init: function() {
		...
		$(document).trigger('wooinit_after', $);
	...
	dowoo: function($) {
		...
		.on( 'change', 'select.country_to_state', function() {
...
jQuery(document).ready(wooobject.dowoo);
